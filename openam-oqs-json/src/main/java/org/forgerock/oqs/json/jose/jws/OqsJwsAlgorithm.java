 ...
 * @since 2.0.0
 */
public enum OqsJwsAlgorithm implements Algorithm {

    /** No digital signature or MAC value included. */
    NONE(null, null, OqsJwsAlgorithmType.NONE),
    /** HMAC using SHA-256 hash algorithm. */
    HS256("HmacSHA256", "SHA-256", OqsJwsAlgorithmType.HMAC),
    /** HMAC using SHA-384 hash algorithm. */
    HS384("HmacSHA384", "SHA-384", OqsJwsAlgorithmType.HMAC),
    /** HMAC using SHA-512 hash algorithm. */
    HS512("HmacSHA512", "SHA-512", OqsJwsAlgorithmType.HMAC),
    /** RSA using SHA-256 hash algorithm. **/
    RS256("SHA256withRSA", "SHA-256", OqsJwsAlgorithmType.RSA),
    /** RSA using SHA-384 hash algorithm. **/
    RS384("SHA384withRSA", "SHA-384", OqsJwsAlgorithmType.RSA),
    /** RSA using SHA-256 hash algorithm. **/
    RS512("SHA512withRSA", "SHA-512", OqsJwsAlgorithmType.RSA),
    /** ECDSA using SHA-256 hash algorithm. */
    ES256("SHA256WithECDSA", "SHA-256", OqsJwsAlgorithmType.ECDSA),
    ...
    private final OqsJwsAlgorithmType algorithmType;

    /**
     * Constructs a new OqsJwsAlgorithm with the Java Cryptographic string name of the algorithm and the OqsJwsAlgorithmType
     * of the algorithm.
     *
     * @param algorithm The Java Cryptographic algorithm name.
     * @param mdAlgorithm The MessageDigest algorithm.
     * @param algorithmType The OqsJwsAlgorithmType of the OqsJwsAlgorithm.
     */
    private OqsJwsAlgorithm(String algorithm, String mdAlgorithm, OqsJwsAlgorithmType algorithmType) {
     ...
     */
    public OqsJwsAlgorithmType getAlgorithmType() {
     ...
     */
    public static OqsJwsAlgorithm getJwsAlgorithm(String algorithm) {
        for (OqsJwsAlgorithm oqsJwsAlgorithm : OqsJwsAlgorithm.values()) {
            if (algorithm.equalsIgnoreCase(oqsJwsAlgorithm.getAlgorithm())) {
                return oqsJwsAlgorithm;
            }
        }
        throw new IllegalArgumentException("Unknown oqsJwsAlgorithm, " + algorithm);
    }
